...
@section('content')
{{-- 用户详情页面：user_id 隐藏字段来自 /admin/users/{id} 路由参数；页面读取 admin_api_userDetail，保存基础资料调用 admin_api_updateUser，启停状态调用 admin_api_changeUserStatus，真实访问必须经过后端权限与数据范围校验。 --}}
...
@section('scripts')
<div hidden data-layui-page="users/detail"></div>
@endsection
