...
@include('front_layui::partials.module-page', [
    ...
    'columns' => [
        ...
        ['key' => 'comm_trans', 'label' => 'front.commission_transfer', 'action' => 'openCommissionTransfer', 'actionLabel' => 'front.commission_transfer', 'idField' => 'user_id', 'linkClass' => 'module-link-order'],
        ['key' => 'change_group', 'label' => 'front.group_change', 'action' => 'openGroupChange', 'actionLabel' => 'front.group_change', 'idField' => 'user_id', 'linkClass' => 'module-link-detail'],
    ],
])
@endsection
