...
/**
 * 创建充值记录表 deposit_records。
 *
 * 文件功能：
 * - 前台用户充值订单：金额、渠道、订单号、状态与支付时间。
 *
 * 字段语义：
 * - user_id/user_name 用户；mt4_ticket MT4 订单号；amount 申请金额；actual_amount 实收金额；
 * - exchange_rate 汇率；channel_name/channel_order_no 渠道名称与渠道订单号；
 * - local_order_no 本地订单号；status 状态（01=待支付 02=已支付 05=退款 09=失败 10=超时）；
 * - payment_time 支付时间；remarks 备注；created_by/updated_by 操作人。
 */
