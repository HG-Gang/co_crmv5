...
/**
 * 创建批量入金导入记录表 deposit_imports。
 *
 * 文件功能：
 * - 后台批量导入入金数据的批次记录：文件名、导入人、结果统计与状态。
 *
 * 字段语义：
...
class CreateDepositImportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('deposit_imports', function (Blueprint $blueprint) {
    ...
    {
        Schema::dropIfExists('deposit_imports');
    }
}
