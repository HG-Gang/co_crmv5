...
/**
 * 创建 MT4 交易表 mt4_trades。
 *
 * 文件功能：
 * - MT4 服务端交易记录镜像：订单号、品种、开平仓、盈亏与余额操作类型。
 *
 * 字段语义：
 * - ticket 订单号（唯一）；login MT4 登录号；symbol 品种；cmd 订单类型；
 * - volume 手数；open_time/open_price 开仓时间价格；close_time/close_price 平仓时间价格；
 * - profit 盈亏；commission/swaps 佣金与隔夜利息；comment 交易备注（出入金来源识别）；
 * - modify_time MT4 修改时间；magic 魔法号。
 */
