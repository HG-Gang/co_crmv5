        ...
        <form action="{{ route('front.register.post') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="tel" name="phone" value="{{ old('phone') }}" placeholder="" data-translate-placeholder="auth.phone" minlength="12" maxlength="20" inputmode="numeric" autocomplete="tel">
                </div>
                <div class="form-group">
