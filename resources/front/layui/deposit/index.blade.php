...
@section('styles')
<link rel="stylesheet" href="{{ asset('/css/front/front-v3.css') }}?v=2026062301">
<style>
    /* 行为关键样式：JS 依赖，必须保留 */
    .crm-v3 .deposit-retry { display: none; margin-left: 10px; }
    .crm-v3.is-disabled .deposit-form-area,
    .crm-v3 .deposit-page.is-disabled .deposit-form-area { opacity: .55; pointer-events: none; }
    .deposit-page.is-disabled .deposit-form-area { opacity: .55; pointer-events: none; }
</style>
@endsection

@section('content')
<div class="deposit-page crm-visual-page crm-deposit-page crm-v3 crm-v3-deposit">
    <div class="layui-card crm-deposit-form-card">
    ...
    <div class="layui-card crm-deposit-history-card">
...
@section('scripts')
<script src="{{ asset('/js/shared/pay-channel-manager.js') }}?v=2026060307"></script>
<script src="{{ asset('/js/shared/deposit-page-core.js') }}"></script>
