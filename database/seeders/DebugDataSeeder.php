...
/**
 * 调试数据 Seeder（开发/演示环境专用）。
 *
 * 文件功能：
 * - 生成系统配置、角色权限、代理级别、交易组等基础数据。
 * - 生成管理员、演示用户以及资金、交易、佣金等业务调试数据。
 *
 * 运行方式：
 * - php artisan db:seed --class=Database\\Seeders\\DebugDataSeeder
 * - 注意：truncateTables() 会清空业务表，默认已注释，生产环境禁止执行本 Seeder。
 */
