...
@include('front_layui::partials.module-page', [
    ...
    'columns' => [
        ['key' => 'user_id', 'label' => 'front.user_id', 'action' => 'updateUserChain', 'idField' => 'user_id', 'linkClass' => 'module-link-user'],
        ['key' => 'user_name', 'label' => 'front.user_name'],
        ['key' => 'agentsTotal', 'label' => 'front.agent_count', 'action' => 'showDirectAgents', 'idField' => 'user_id', 'actionIf' => 'can_drill_agents', 'linkClass' => 'module-link-user'],
        ['key' => 'accountTotal', 'label' => 'front.customer_count', 'action' => 'showDirectCustomers', 'idField' => 'user_id', 'actionIf' => 'can_drill_customers', 'linkClass' => 'module-link-user'],
