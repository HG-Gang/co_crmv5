...
<body class="crm-ui-front-shell" data-ui-family="layui" data-ui-surface="front" data-visual-direction="c">
    ...
    <script src="{{ asset('js/shared/lang/common/' . app()->getLocale() . '.js') }}?v=2026060403"></script>
    <script src="{{ asset('js/apps/front/layui/pages.js') }}?v=2026070402"></script>
    @yield('scripts')
</body>
</html>
