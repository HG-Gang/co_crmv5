...
/**
 * 创建官网离线反馈表 offweb_feedbacks。
 *
 * 文件功能：
 * - 旧官网意见反馈提交记录（姓名、联系方式、内容），邮件发送见 config/mail.php feedback_to。
 *
 * 字段语义：
 * - name 姓名；contact 联系方式；content 反馈内容；
 * - status 处理状态（未处理/已处理）；processed_by/processed_at 处理人与时间。
 */
