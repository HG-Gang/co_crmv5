...
/**
 * 创建礼品发货记录表 gift_shipments。
 *
 * 文件功能：
 * - 用户礼品发放/发货单：礼品项、收货地址、物流信息与发货状态。
 *
 * 字段语义：
 * - user_id 用户 ID；gift_item_id 礼品项 ID；address_id 收货地址 ID；
 * - quantity 数量；tracking_no 物流单号；carrier 物流公司；
 * - status 状态（待发货/已发货/已签收）；remark 备注。
 */
