...
/**
 * AdminFengXianRiskMatrixClosureTest
 *
 * 文件功能：
 * - 验证风控模块九条路由的证据矩阵：每条路由有独立完整证据，全局矩阵汇总与风控闭环一致。
...
final class AdminFengXianRiskMatrixClosureTest extends TestCase
{
    /**
     * 后台风控证据组的键名。按它从核验矩阵 JSON（storage/app/audits/旧项目模块逻辑迁移核验矩阵.json）
     * 筛选本模块行并断言每行 verification_group 与之一致；值不匹配即门禁失败，防止证据混组。
     */
    private const VERIFICATION_GROUP = 'admin_fengxian_risk_business_2026_08_18';
    ...
    /**
     * 风控模块（盈利榜/持仓风险/IP 管控）的旧路由认领清单：键为「HTTP 方法 旧URI」，值为矩阵认定的当前路由名。
     * 门禁逐条断言 verified、绑定与七维独立出证；路由增删必须同步维护，否则漏出证或误报。
     */
    private const EXPECTED_ROUTES = [
        'GET index/admin/fengXian/profit_list' => 'legacy_admin_1820f13a8bd1f4b4',
        'POST index/admin/fengXian/profitSearch' => 'legacy_admin_37967de6002975f4',
        'POST index/admin/fengXian/profitSearchV2' => 'legacy_admin_067c5336cc8d7f1f',
        'GET index/admin/fengXian/position_list' => 'legacy_admin_301b9ab00f34a0af',
        'POST index/admin/fengXian/positionSearch' => 'legacy_admin_2ebb7d8224ca15d3',
        'POST index/admin/fengXian/positionSearchv2' => 'legacy_admin_ef87bc3816cc4e56',
        'GET index/admin/fengXian/Ipaddress_list' => 'legacy_admin_c82de95a228251b7',
        'POST index/admin/fengXian/IpaddressSearch' => 'legacy_admin_a7247b9891d8643b',
        'GET index/admin/fengXian/IpaddressDeatail/{idaddr}' => 'legacy_admin_40570f7ac589f230',
    ];

    public function test_all_nine_fengxian_routes_have_independent_complete_evidence(): void
    {
    ...
    public function test_global_matrix_summary_reflects_the_fengxian_closure(): void
    {
        $matrix = $this->readMatrix();
        ...
        $this->assertGreaterThanOrEqual(415, $counts['verified']);
    }
