...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
        ...
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->registerUser($data);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function deposit($userId, $amount, $comment)
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->deposit($userId, $amount, $comment);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function withdrawal($userId, $amount, $comment)
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->withdrawal($userId, $amount, $comment);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->verifyPassword($userId, $password);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function creditIn($userId, $amount, $comment, $expires = 999)
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->creditIn($userId, $amount, $comment, $expires);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->getAccountInfo($userId);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function changePassword($userId, $newPwd, $oldPwd = '')
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->changePassword($userId, $newPwd, $oldPwd);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->lockUser($userId);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->unlockUser($userId);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->enableUser($userId);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->disableUser($userId);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function changeGroup($userId, $newGroup)
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->changeGroup($userId, $newGroup);
        }
                    /**
         * 一次更新 MT4 用户交易组和杠杆。
         * 
         ...
         * @static 
         */ 
        public static function updateUserTradingProfile($userId, $group, $leverage)
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->updateUserTradingProfile($userId, $group, $leverage);
        }
                    /**
         ...
         * @static 
         */ 
        public static function updateUserHierarchy($userId, $parentId, $relationshipCode)
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->updateUserHierarchy($userId, $parentId, $relationshipCode);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function updateComment($userId, $comment)
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->updateComment($userId, $comment);
        }
                    /**
         ...
         * @static 
         */ 
        public static function closeOrder($userId, $ticket, $comment = '')
        {
                        /** @var \App\Services\Mt4ManagerService $instance */
                        return $instance->closeOrder($userId, $ticket, $comment);
        }
...
namespace  { 
            ...
            class Mt4ManagerApi extends \App\Facades\Mt4ManagerApi {}
